...
export class BasePage {
  ...
  get conduitIcon(): Locator {
    ...
    return this.page.getByRole("navigation").getByRole("link", { name: "conduit" }).first();
  }
  ...
  get homePageMessage(): Locator {
    return this.page.getByText("A place to learn and practice test automation.");
  }

  get bondarAcademyLink(): Locator {
    return this.page.getByRole("link", { name: "www.bondaracademy.com", exact: true });
  }
